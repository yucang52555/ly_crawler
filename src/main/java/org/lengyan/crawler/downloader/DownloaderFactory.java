...
public abstract class DownloaderFactory {
	...
	public DownloaderFactory(Reflections reflections) {
		...
		Set<Class<?>> classes = reflections.getTypesAnnotatedWith(org.lengyan.crawler.annotation.Downloader.class);
		for(Class<?> downloaderClass : classes) {
			org.lengyan.crawler.annotation.Downloader downloader = (org.lengyan.crawler.annotation.Downloader)downloaderClass.getAnnotation(org.lengyan.crawler.annotation.Downloader.class);
			try {
